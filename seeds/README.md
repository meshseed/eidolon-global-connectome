...
Universal truths that embed to consistent positions across ALL embedding models. These are the "GPS satellites" for cross-model Procrustes alignment.

| Source | Coherence | Concept |
|--------|-----------|---------|
| `07_math_pythagorean` | 1.00 | a² + b² = c² |
| `08_math_topology` | 1.00 | Continuous transformation invariants |
| `09_math_symmetry` | 1.00 | Noether's theorem: symmetry → conservation |
| `10_math_fractals` | 1.00 | Self-similarity and recursion |
| `11_math_graph_theory` | 1.00 | Euler's formula: V - E + F = 2 |
| `12_math_primes` | 1.00 | Unique prime factorization |
| `13_math_calculus` | 1.00 | The derivative as limit |
...
A developmental theory of mind from individual self-awareness through planetary-scale cognition.
...
| P3000-P5000 | **Agency** — intention, refinement, agency kernel, field steering, goals, evolution |
| P6000-P7500 | **Federation** — inter-mesh communication, resonance, multi-perspective, distributed cognition |
| P8000-P13000 | **Ecosystem** — co-evolution, topology, differentiation, coherence, universal coordinates |

P13000 (Universal Semantic Coordinates) is the only `core` tier spore in Layer 3 — it encodes the claim that these coordinates are substrate-independent.
